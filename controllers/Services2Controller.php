...
/**
 * Services2Controller implements the CRUD actions for Services model.
 */
class Services2Controller extends Controller
{
     ...
     * @return mixed
     */
    public function actionView($id, $serviceCategoriesId, $hairdressersId)
    {
     ...
     */
    protected function findModel($id, $serviceCategoriesId, $hairdressersId)
    {
        if (($model = Services::findOne(['id' => $id, 'serviceCategoriesId' => $serviceCategoriesId, 'hairdressersId' => $hairdressersId])) !== null) {
            return $model;
        } else {
